  ...
  return (
    <div className="bg-black text-white font-sans">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 bg-gradient-to-b from-black to-gray-900">
        ...
        >
          We craft powerful content, videos, and digital strategies that help
          brands stand out and dominate online.
        </motion.p>
        <a
          href="#contact"
          ...
          {[1, 2, 3].map((t) => (
            ...
            >
              <p className="text-gray-300 mb-4">
                "Even GOATS completely transformed our online presence. Highly
                recommend!"
              </p>
